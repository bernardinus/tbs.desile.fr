...
angular.module('tbsApp').factory('RTBEventName', function() {
    ...
    var names = {
        ...
        'buddy_slot_event_gold_for_10' : '【Companions of Truth】 1 S-Class or higher companion guaranteed !',
        ...
        'sp_ch_2005-1' : 'Mobius Final Fantasy in Arena',
        'sp_ch_2006-1' : '【Lucia】 Lucia in Arena',
